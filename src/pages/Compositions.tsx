...
export default function Compositions() {
  ...
  const handleGenerate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Starting composition generation with:', {
        profilePhotoLength: pose.image.length,
        clothingItems: images.length,
        descriptions: descs,
        quality
      });
      ...
      console.log('Generated composition result length:', b64.length);
      ...
      // Don't save a fallback composition - let the user see the error and try again
      setIsGenerating(false);
    }
  };
